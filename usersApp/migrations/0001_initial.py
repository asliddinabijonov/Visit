    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('sayohatchi', 'Sayohatchi'), ('taxi_egasi', 'Taxi park egasi'), ('gid', 'Gid (yo‘lboschi)'), ('mehmonxona_egasi', 'Mehmonxona egasi')], max_length=30, verbose_name='Foydalanuvchi turi')),
